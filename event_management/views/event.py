...
class EventCreateView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        serializer = EventCreateSerializer(data=data, many=True)
        print(type(data.getlist('preferences')))
        for i, component in enumerate(data.getlist('preferences')):
            print(type(i), type(component))
